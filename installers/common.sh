...
function download_latest_files() {
    ...
    git clone --depth 1 https://github.com/SomasunderAsteroid/raspap-webgui/tree/raspap-customzied /tmp/raspap-webgui || install_error "Unable to download files from github"
